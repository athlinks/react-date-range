    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          !athlinksCustom && this.props.staticRanges.map(function (staticRange, i) {
          ...
          athlinksCustom && this.props.staticRanges.filter(function (_) {
            return !!_.ranges;
          }).map(function (staticRange, i) {
            return _react2.default.createElement(
              'div',
              { key: i },
              _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)(_styles2.default.rangeLabel) },
                staticRange.label
              ),
              staticRange.ranges.map(function (sectionRange, i) {
                var _getSelectedRange2 = _this2.getSelectedRange(ranges, sectionRange),
                    selectedRange = _getSelectedRange2.selectedRange,
                    focusedRangeIndex = _getSelectedRange2.focusedRangeIndex;
                ...
                return _react2.default.createElement(
                  'button',
                  {
                    ...
                    key: i,
                    onClick: function onClick() {
                      return _this2.handleRangeChange(sectionRange.range(_this2.props));
                    },
                    onFocus: function onFocus() {
        ...
        _react2.default.createElement(
          ...
          !athlinksCustom && this.props.inputRanges.map(function (rangeOption, i) {
            return _react2.default.createElement(
              'div',
...
DefinedRanges.propTypes = {
  ...
  athlinksCustom: _propTypes2.default.bool
};
